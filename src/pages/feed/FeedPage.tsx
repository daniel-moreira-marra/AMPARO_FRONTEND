...
import { useFeed, type FeedFilters } from "@/hooks/useFeed";
import { FeedItem } from "@/components/feed/FeedItem";
import { CreatePostWidget } from "@/components/feed/CreatePostWidget";
import { FeedHeader } from "@/components/layout/feed/FeedHeader";
import { Skeleton } from "@/components/ui/skeleton";
import type { UserRole } from "@/types";

type ActiveFilters = FeedFilters & { role?: UserRole | "ALL" };

export const FeedPage = () => {
    const [rawFilters, setRawFilters] = useState<ActiveFilters>({});
    const [debouncedFilters, setDebouncedFilters] = useState<FeedFilters>({});
    ...
    return (
        <div className="space-y-4">
            <FeedHeader filters={rawFilters} onFiltersChange={handleFiltersChange} />
