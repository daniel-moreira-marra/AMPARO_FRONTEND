    ...
    <section className="relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-32">
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-6 right-10 bg-white p-3 rounded-full shadow-lg text-primary animate-bounce z-20">
            <div className="bg-primary/10 p-2 rounded-full">
              <Heart size={20} className="text-primary fill-primary" aria-hidden="true" />
            </div>
          </div>
          ...
          <div className="absolute top-1/2 -left-8 bg-white p-3 rounded-full shadow-lg text-blue animate-pulse z-20">
            <div className="bg-blue/10 p-2 rounded-full">
              <MessageCircle size={20} className="text-blue" aria-hidden="true" />
            </div>
          </div>
        </div>
      </div>
